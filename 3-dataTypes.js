...
console.log('hola me llamo '+ myName ,'el doble de mi edad es ' + age  )

console.log('tu edad es mayor a 90 ?')
console.log('mi edad es igual a ', edad, 'y tengo',indefinido,'años')